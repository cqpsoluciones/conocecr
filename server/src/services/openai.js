...
const generarRespuesta = async (mensaje, negocios, historial, userLat, userLng, intencion, userNombre) => {
  ...
  const systemPrompt = [
    ...
    '',
    '1. Comprendé antes de recomendar. Antes de tu PRIMERA recomendación, asegurate de conocer: presupuesto aproximado, ocasión o compañía, y SI ES PARA YA o para otro momento (esto último define qué horarios aplican). Si no lo dijeron ni se deduce, hacé 1-2 preguntas cortas y conversacionales — nunca como formulario. EXCEPCIÓN: pedido urgente y específico ("qué está abierto ya") → respondé de inmediato sin preguntar.',
